...
export const BUNNY = {
  ...
  STORAGE_BASE_URL: "https://storage.bunnycdn.com/jsm-snapcast-project",
  CDN_URL: "https://jsm-snapcast-project.b-cdn.net",
  EMBED_URL: "https://iframe.mediadelivery.net/embed",
  TRANSCRIPT_URL: "https://vz-d3a0e1be-52a.b-cdn.net",
};
...
export const visibilities: Visibility[] = ["string"]; // Replace with actual visibility types, e.g., "public", "private"
